        ...
        <div class="right-btn">
          <a-button-group>
            <a-button
              ...
              icon="printer"
              @click="printOrder"
              :disabled="!hasPermission('outbound_list_print')"
            >
              打印出库单
            </a-button>
            <a-button
              ...
              icon="download"
              @click="exportItem"
              :disabled="!hasPermission('outbound_list_export')"
            >
              导出订单
            </a-button>
          </a-button-group>
        ...
        >
          ...
          <div slot="opreation" slot-scope="text, record">
            <a-button
              ...
              :disabled="!hasPermission('outbound_list_detail')"
              >查看订单</a-button
            >
          </div>
        </a-table>
...
import {
  ...
  GetOrderType,
  ExportData,
} from "../../services/warehouseManagement/outWarehouse/outboundList";
...
export default {
  ...
  methods: {
    ...
    downloadTem(url) {
      ...
      link.setAttribute("download", "已出库单");
