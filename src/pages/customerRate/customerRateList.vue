    ...
    <div class="search">
      <a-form :form="searchform">
        <a-row :gutter="16">
          ...
          <a-col :span="4">
            <a-form-item>
              <a-input v-model.trim="searchform.partnerName" placeholder="客户名称">
              </a-input>
            </a-form-item>
          </a-col>
          <a-col :span="4">
      ...
      >
        <span slot="operation" slot-scope="record">
          <a-button
            ...
            :disabled="!hasPermission('customer_rate_configuration_rules')"
          >
            配置规则
          </a-button>
          <a-popconfirm
            :disabled="!hasPermission('customer_rate_cancel_match')"
            title="确定要取消匹配数据的规则吗?"
            ok-text="确定"
            cancel-text="取消"
