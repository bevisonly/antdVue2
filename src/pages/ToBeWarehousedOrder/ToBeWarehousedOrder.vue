      ...
      >
          ...
          <div class="right-btn">
            <a-button-group>
              <a-button
                ...
                icon="printer"
                @click="printOrder"
                :disabled="!hasPermission('to_be_warehoused_order_print')"
              >
                打印入库单
              </a-button>
              <a-button
                ...
                icon="download"
                @click="exportItem"
                :disabled="!hasPermission('to_be_warehoused_order_export')"
              >
                导出订单
              </a-button>
            </a-button-group>
        ...
        >
          <div slot="imItemTypeName" slot-scope="text">
            <a-tag>{{ text }}</a-tag>
            <!-- <a-tag v-if="text == 20">采购订单入库</a-tag>
          ...
          <div slot="opreation" slot-scope="text, record">
            <a-button
              ...
              :disabled="!hasPermission('to_be_warehoused_order_detail')"
              >查看订单</a-button
            >
            <!-- <a-popconfirm
              title="确定进行入库操作吗?"
              ok-text="确定"
              cancel-text="取消"
              @confirm="warehousing(record)"
              v-if="record.imItemType != 104"
              :disabled="!hasPermission('to_be_warehoused_order_put_in')"
            >
              <a-button
                type="link"
                :disabled="!hasPermission('to_be_warehoused_order_put_in')"
            ...
            <a-popconfirm
              ...
              :disabled="!hasPermission('to_be_warehoused_order_del')"
              v-if="record.imItemType != 23"
            >
              <a-button
                type="link"
...
export default {
  ...
  methods: {
    ...
    downloadTem(url) {
      ...
      link.setAttribute("download", "待入库单");
