    ...
    <div class="btns">
      <a-button-group>
        <a-button
          ...
          icon="plus"
          @click="toAdd"
          :disabled="!hasPermission('input_rate_insert')"
        >
          新增
        </a-button>
      </a-button-group>
      ...
      >
        <span slot="operation" slot-scope="record">
          <a-button
            ...
            :disabled="!hasPermission('input_rate_details')"
          >
            详情
          </a-button>
          <a-button
            ...
            :disabled="!hasPermission('input_rate_view_supplier')"
          >
            查看供应商
          </a-button>
          <a-button
            type="link"
            @click="edit(record)"
            :disabled="!hasPermission('input_rate_edit')"
          >
            编辑
          </a-button>
          <a-button
            type="link"
            @click="close(record)"
            :disabled="!hasPermission('input_rate_close')"
          >
