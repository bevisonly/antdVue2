...
<script>
import { GetDetails } from "../../services/settlement/payable/PayableCertificateToBeGenerated";
const columns = [
  {
    align: "center",
    title: "客户单号",
      ...
      GetDetails(params).then((res) => {
        ...
        if (res.data.code == 200) {
          ...
          this.basicInfo = {
            ...
            // puTotalAmount: item.puTotalAmount / 100 || "",
          ...
          this.tableDetail.forEach((v) => {
            v.deliveryNetweight = v.deliveryNetweight / 1000||'';
          });
