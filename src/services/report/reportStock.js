...
export function search(params) {
  return request(`BusinessReport/futuresReportDate.action`, METHOD.POST, params)
}

//! 导
export function exportData(params) {
  return request(`BusinessReport/exportFuturesReportDate.action`, METHOD.POST, params, {responseType: 'blob'})
}
